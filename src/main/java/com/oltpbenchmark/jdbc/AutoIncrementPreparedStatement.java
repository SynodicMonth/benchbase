...
public class AutoIncrementPreparedStatement implements PreparedStatement {
  ...
  public ResultSet executeQuery(String sql) throws SQLException {
    // TODO: extract SQL, Value length restriction
    ResultSet result = QueryCacheHacker.getInstance().get(sql);
    if (result != null) {
      return result;
    } else {
      ResultSet res = this.stmt.executeQuery(sql);
      CachedRowSet cachedRowSet =
          RowSetProvider.newFactory("com.sun.rowset.RowSetFactoryImpl", null).createCachedRowSet();
      cachedRowSet.populate(res);
      QueryCacheHacker.getInstance().set(sql, cachedRowSet);
      return cachedRowSet;
    }
  }
  ...
  public int executeUpdate(String sql) throws SQLException {
    QueryCacheHacker.getInstance().invalidateAll();
  ...
  public ResultSet executeQuery() throws SQLException {
    // TODO: extract SQL, Value length restriction
    ResultSet result = QueryCacheHacker.getInstance().get(stmt.toString());
    if (result != null) {
      return result;
    } else {
      ...
      CachedRowSet cachedRowSet =
          RowSetProvider.newFactory("com.sun.rowset.RowSetFactoryImpl", null).createCachedRowSet();
      cachedRowSet.populate(res);
      QueryCacheHacker.getInstance().set(stmt.toString(), cachedRowSet);
      return cachedRowSet;
    }
  }
